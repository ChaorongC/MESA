...
plots_1 <- plotFig2("colonCancer/matrixUS_20220406/US_colon.Cancer.siteMethyRatio.final.tsv",
                    "colonCancer/matrixUS_20220406/US_colon.Non-Cancer.siteMethyRatio.final.tsv", 
                    "Manuscript/US_correct_methylation_crchen_20220508/US_probability_20220507.csv")
plots_2 <- plotFig2("colonCancer/China_colon_all_feature_80_200_03162022/China_colon.Cancer.siteMethyRatio.tsv",
                    "colonCancer/China_colon_all_feature_80_200_03162022/China_colon.Non-Cancer.siteMethyRatio.tsv", 
                    "Manuscript/probability_20220504/CN_probability_20220504.csv")
...
p1 <- plotAUC("Manuscript/probability_nucleosome_new_20220505/US_nucleosome_probability_20220504.csv", 
               "Manuscript/probability_nucleosome_new_20220505/US_nucleosome_combine_probability_20220504.csv")
p2 <- plotAUC("Manuscript/CN_20220517/CN_nucleosome_probability_20220516.csv",
               "Manuscript/CN_20220517/CN_combine_probability_20220516.csv")
...
p1 <- plotROCsFig5("Manuscript/US_20220512/US_combine_probability_20220510.csv", "colonCancer/Colon_sampleID_ageFilter_stageInfor.tsv", USstageAUC)
p2 <- plotROCsFig5("Manuscript/CN_20220517/CN_combine_probability_20220517.csv", "colonCancer/China_Colon_sampleID_stageInfor.tsv", CNstageAUC)
...
plotProb("Manuscript/US_20220512/US_combine_probability_20220510.csv", "Manuscript/figures/Fig. 5E.pdf", "Manuscript/figures/v6/Fig. 5G.pdf")
plotProb("Manuscript/CN_20220517/CN_combine_probability_20220517.csv", "Manuscript/figures/Fig. 5F.pdf", "Manuscript/figures/v6/Fig. 5H.pdf")

########## Fig. 6 ##########
myColors=c("red", "purple", "#317EC2", "#E7872B")
myModels=c("Multimodal", "Methylation", "Occupancy", "Fragmentation")
df <- read.csv(file="cfTAPS/results from Chaorong/cfTAPS_NvsC_combine_probability_20220605.csv", header = T, check.names = F)
...
df <- read.csv(file="cfTAPS/results from Chaorong/cfTAPS_3class_combine_probability_20220605.csv", header = T, check.names = F)
accuracies = c()
